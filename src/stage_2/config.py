...
class Arguments(TrainingArguments):
    stage: str = field(
        default='stage_2', metadata={"help": "Path to source code"}
    )
    ...
    data_dir: str = field(
        default='./data/msmarco_bm25_official', metadata={"help": "Path to train directory"}
    )
